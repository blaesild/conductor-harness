...
4. Read `.harness/progress.md` if it exists.
5. Write a 3-5 line summary of: what you're building, what you know from memory, and the first concrete action you'll take.
6. Update `.harness/progress.md` with: Linear issue, task summary, status: in-progress, started: [date].
